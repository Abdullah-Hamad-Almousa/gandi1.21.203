...
@EventBusSubscriber(modid = GandI.MOD_ID)
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent e){
        ...
        generator.addProvider(e.includeServer(), new ModItemTagProvider(packOutput, lookupProvider, blockTagsProvider
                .contentsGetter(), existingFileHelper));
        generator.addProvider(e.includeServer(), new ModRecipeProvider(packOutput, lookupProvider));
        generator.addProvider(e.includeServer(), new ModDataMapProvider(packOutput, lookupProvider));
